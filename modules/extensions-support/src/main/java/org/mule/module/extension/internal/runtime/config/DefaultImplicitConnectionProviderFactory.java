...
final class DefaultImplicitConnectionProviderFactory extends BaseImplicitObjectFactory implements ImplicitConnectionProviderFactory
{

    DefaultImplicitConnectionProviderFactory(ExpressionManager expressionManager)
    {
    ...
    public <Config, Connector> ConnectionProvider<Config, Connector> createImplicitConnectionProvider(String configName, ExtensionModel extensionModel, MuleEvent event)
    {
        ...
        final ResolverSet resolverSet = buildImplicitResolverSet(implicitModel);
        try
        {
