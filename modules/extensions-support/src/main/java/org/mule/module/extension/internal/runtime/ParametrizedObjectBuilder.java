...
public abstract class ParametrizedObjectBuilder<T> extends BaseObjectBuilder<T>
{
    ...
    public ParametrizedObjectBuilder(Class<?> prototypeClass, EnrichableModel model, ResolverSet resolverSet)
    {
