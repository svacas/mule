 ...
 * @since 3.8.0
 */
public final class DefaultImplicitConfigurationFactory extends BaseImplicitObjectFactory implements ImplicitConfigurationFactory
{

    public DefaultImplicitConfigurationFactory(ExpressionManager expressionManager)
    {
    ...
    public <C> ConfigurationInstance<C> createImplicitConfigurationInstance(ExtensionModel extensionModel, MuleEvent event)
    {
        ...
        final ResolverSet resolverSet = buildImplicitResolverSet(implicitConfigurationModel);
        try
        {
