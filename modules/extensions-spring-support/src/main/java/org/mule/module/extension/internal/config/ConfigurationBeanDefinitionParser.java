...
final class ConfigurationBeanDefinitionParser extends BaseExtensionBeanDefinitionParser
{
    ...
    protected void doParse(BeanDefinitionBuilder builder, Element element, ParserContext parserContext)
    {
        ...
        parseConfigurationProvider(element, builder, parserContext);
    }

    private void parseConfigurationProvider(Element element, BeanDefinitionBuilder builder, ParserContext parserContext)
    {
        if (configurationModel.getExtensionModel().getConnectionProviders().isEmpty())
        {
            nullConnectionProviderFor(builder);
            return;
        }
    ...
    private void nullConnectionProviderFor(BeanDefinitionBuilder builder)
    {
